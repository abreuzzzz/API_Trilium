...
SHEET_ID2 = "1XhSDhoGxWORTLOVGH4JCF4kyFsXjlzQAkOUXoSccXic"  # ID da planilha de destino
...
spreadsheet = gc.open_by_key("1XhSDhoGxWORTLOVGH4JCF4kyFsXjlzQAkOUXoSccXic")
